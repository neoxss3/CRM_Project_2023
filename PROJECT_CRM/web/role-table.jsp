<%-- 
    Document   : role-table
    Created on : Aug 19, 2023, 2:56:17 PM
    Author     : anhbs
--%>
                            ...
                            <div class="white-box">
                                <div class="table-responsive">
                                    ...
                                    <table class="table" id="example">
                                        ...
                                        <tbody>
                                            <c:forEach var ="rl" items="${LIST_ROLE}">
                                                <tr>
                                                    <td>${rl.getId()}</td>
                                                    <td>${rl.getName()}</td>
                                                    <td>${rl.getDesc()}</td>
                                                    <td>
                                                        ...
                                                        <a href="#" role-id="${rl.getId()}" class ="btn btn-sm btn-danger btn-delete">Xóa</a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
