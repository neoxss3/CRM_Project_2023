<%-- 
    Document   : user-table
    Created on : Aug 23, 2023, 10:47:45 AM
    Author     : anhbs
--%>
                            ...
                            <div class="white-box">
                                <div class="table-responsive">
                                    <table class="table" id="example">
                                        ...
                                        <tbody>
                                            <c:forEach var ="lu" items="${LIST_USER}">
                                                <tr>
                                                    <td>${lu.getId()}</td>
                                                    <td>${lu.getFullName()}</td>
                                                    <td>${lu.getEmail()}</td>
                                                    <td>${lu.getRole().getName()}</td>
                                                    <td>
                                                        <a href="user-detail?userid=${lu.getId()}"  class="btn btn-sm btn-info">Xem & Sửa</a>
