 ...
 * @author anhbs
 */
@WebServlet(name = "APIRole", urlPatterns = {"/api/role/delete", "/api/role/update"})
public class APIRole extends HttpServlet {
    ...
    protected void doPut(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            boolean check = rs.updateRole(id, name, desc);
            BaseResponse res = new BaseResponse();
            res.setStatusCode(200);
            res.setMessage((check) ? "Update Thành công" : "Update Thất bại");
            res.setData(check);
            ...
            System.out.println("Update Error" + ex.getLocalizedMessage());
        }
