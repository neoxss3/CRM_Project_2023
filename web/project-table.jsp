<%-- 
    Document   : project
    Created on : Sep 6, 2023, 8:31:03 PM
    Author     : anhbs
--%>
                            ...
                            <div class="white-box">
                                <div class="table-responsive">
                                    <table class="table" id="example">
                                        ...
                                        <tbody>
                                            <c:forEach var ="pj" items="${PROJECT_INFO}" varStatus="counter">
                                                <tr>
                                                    <td>${counter.count}</td>
                                                    <td>${pj.getProject_name()}</td>
                                                    <td>${pj.getStarting_date()}</td>
                                                    <td>${pj.getEnd_date()}</td>
                                                    <td>
