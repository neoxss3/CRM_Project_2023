<%-- 
    Document   : task
    Created on : Sep 10, 2023, 8:29:39 PM
    Author     : anhbs
--%>
                            ...
                            <div class="white-box">
                                <div class="table-responsive">
                                    <table class="table" id="example">
                                        ...
                                        <tbody>
                                            <c:forEach items="${TASK_INFO}" var="ti" varStatus="counter">
                                                <tr>
                                                    <td>${counter.count}</td>
                                                    <td>${ti.getTask_name()}</td>
                                                    <td>${ti.getPj().getProject_name()}</td>
                                                    <td>${ti.getPj().getUs().getFullName()}</td>
                                                    <td>${ti.getStarting_date()}</td>
                                                    <td>${ti.getEnd_date()}</td>
                                                    <td>${ti.getStt().getStatus_name()}</td>
                                                    <td>
