<%-- 
    Document   : user-add
    Created on : Aug 23, 2023, 11:58:36 AM
    Author     : anhbs
--%>
                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h4 class="page-title">Thêm mới thành viên
                                <h4 style="color: red">${CREATE_USER_ERROR}</h4>
                            </h4>
                        </div>
                    </div>
                    <!-- /.row -->
                            ...
                            <div class="white-box">
                                <form action ="<c:url value='/user-add'/>" class="form-horizontal form-material" method="POST">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Your Name" name="crename"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="email" placeholder="abc@..."
                                                   class="form-control form-control-line" name="cremail"
                                                   id="example-email" required> </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Password</label>
                                        <div class="col-md-12">
                                            <input type="password" name="crepass" class="form-control form-control-line" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Re-type Password</label>
                                        <div class="col-md-12">
                                            <input type="password" name="confirmpass" class="form-control form-control-line" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Phone No</label>
                                        <div class="col-md-12">
                                            <input type="text" name="crephone"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <select class="form-control form-control-line" name="crerole">
                                                <c:forEach items="${LIST_ROLE}" var="lr">
                                                    <option value="${lr.getId()}">${lr.getName()}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                    </div>
